  ...
  return <>
    <div tw="relative col-span-2 md:col-span-1">
      <ResponsiveContainer width="100%" aspect={1.5}>
        <LineChart data={tradingData?.market_caps} syncId={coin.id} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
          ...
          <Line type="monotone" dataKey="1" name={`${coin.symbol} Market Cap`} r={0} strokeWidth={2} animateNewValues={false} stroke={theme`colors.bbg.cyan`}/>
        </LineChart>
      </ResponsiveContainer>
