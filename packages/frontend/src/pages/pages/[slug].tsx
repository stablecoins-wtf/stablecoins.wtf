...
export const getStaticPaths: GetStaticPaths = getArticleTypeStaticPaths(ArticleType.Page)
export const getStaticProps: GetStaticProps = getSharedStaticPropsFor(SharedStatisPropsPage.PAGE)
